...
export default function AppointmentManagement() {
  ...
  return (
    <div className="mx-2 my-2 sm:mx-auto sm:max-w-7xl sm:px-2">
      ...
      {appointment.appointments ? (
                    ...
                    <Grid item xs={12}>
                      <Form.Item className="mb-0">
                        <div className="flex justify-between">
                          <Button
                            style={{ border: "none" }}
                            className="rounded-md bg-red-600 text-white transition duration-300 hover:bg-red-700 hover:text-white focus:bg-red-700 focus:text-white"
                          ...
                          <Button
                            style={{ border: "none" }}
                            className="rounded-md bg-green-600 text-white transition duration-300 hover:bg-green-700 hover:text-white focus:bg-green-700 focus:text-white"
        ...
        !appointment.appointments && (
          ...
          >
            ...
            >
              <p className=" text-bold text-center text-3xl text-white">
